        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="btn btn-light btn-lg mt-3">Hemen Başlayın</a>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center p-4">
                                <div class="feature-icon bg-primary rounded-circle d-inline-flex align-items-center justify-content-center mb-3"
                                    ...
                                    <i class="<?php echo e($feature['icon']); ?> text-white fa-2x"></i>
                                </div>
                                <h5 class="card-title fw-bold"><?php echo e($feature['title']); ?></h5>
                                <p class="card-text text-muted"><?php echo e($feature['description']); ?></p>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\waybross\resources\views/home.blade.php ENDPATH**/ ?>