    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            ...
            <span class="btn btn-sm btn-outline-secondary">
                <i class="fas fa-calendar me-1"></i><?php echo e(now()->format('d.m.Y')); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($stats['total_contacts']); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($stats['unread_contacts']); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($stats['recent_contacts']); ?></div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('admin.contacts')); ?>" class="btn btn-sm btn-primary">
                            ...
                            <table class="table table-hover">
                                ...
                                <?php $__currentLoopData = $recentMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($message->is_read ? '' : 'table-warning'); ?>">
                                        ...
                                        <td>
                                            <small><?php echo e($message->created_at->format('d.m.Y')); ?></small>
                                            <br>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('admin.contacts.show', $message->id)); ?>"
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\waybross\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>